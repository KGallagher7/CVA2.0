...
Experts were asked to score species independently, and then met for three virtual discussion workshops to discuss scores with other experts. They were then given the chance to finalize their scores based on these discussions. We asked reviewers to **not** consider the scores from the original analysis to reduce bias in the results. 
