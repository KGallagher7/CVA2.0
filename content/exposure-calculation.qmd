...
![Bottom Temperature Raw Exposure comparing 2019-2019 and 2025-2035](bottomT_exposure.jpg)
...
![Bottom Temperature Ranked Exposure comparing 2019-2019 and 2025-2035](bottomT_exposure_ranked.jpg)
...
![Variable-specific exposures across time](exposure_variable_timeseries.png)

![Variable-specific exposures across space](exposure_variable_maps.png)
...
![Total Exposure using all ecologically-relevant variables across time](exposure_timeseries_all.png)

![Total Exposure using only important variables across time](exposure_timeseries_subset.png)

![Total Exposure using all ecologically-relevant variables across space](exposure_total_maps_all.png)

![Total Exposure using only important variables across space](exposure_total_maps_subset.png)
