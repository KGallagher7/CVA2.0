...
#### Example
In the below example directory, CVA2.0 is the working directory, species_list.csv is the csv file containing a list of species to perform the analysis for, and feeding/habitat_key.csv are the respective keys. 
.
└── CVA2.0/
    ├── TargetSpecies/
    │   ├── input_rasters/
